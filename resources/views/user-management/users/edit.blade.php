		...
		<div class="col-xl">
			<div class="card">
				<div class="card-body">
					...
					<form method="post" action="{{ route('user-management.users.update', $user->id) }}" id="user-form-add" enctype="multipart/form-data">
						@csrf
						@method('patch')
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Username" value="{{ old('name') ?? $user->name}}" required>
									@error('name')
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									...
									<div class="form-image logo">
										<img id="profile-preview" src="{{ asset($user->profile) }}">
